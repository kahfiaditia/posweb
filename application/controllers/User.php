...
class User extends CI_Controller {
									...
									$this->form_validation->set_message('min_lenght','{field} Minimal 5 Karakter');
									$this->form_validation->set_message('is_unique','{field} username sudah dipakai, Ganti baru');
